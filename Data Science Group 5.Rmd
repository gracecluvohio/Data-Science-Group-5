...
colnames(data.21.22) <- paste(colnames(data.21.22),"21.22",sep="_")
names(data.21.22)
data.21.22 <- data.21.22 %>% rename(Squad = Squad_21.22)
```
...
colnames(data.20.21) <- paste(colnames(data.20.21),"20.21",sep="_")
names(data.20.21)
data.20.21 <- data.20.21 %>% rename(Squad = Squad_20.21)
```
...
colnames(data.19.20) <- paste(colnames(data.19.20),"19.20",sep="_")
names(data.19.20)
data.19.20 <- data.19.20 %>% rename(Squad = Squad_19.20)
```
...
colnames(data.18.19) <- paste(colnames(data.18.19),"18.19",sep="_")
names(data.18.19)
data.18.19 <- data.18.19 %>% rename(Squad = Squad_18.19)
```
...
colnames(data.17.18) <- paste(colnames(data.17.18),"17.18",sep="_")
names(data.17.18)
data.17.18 <- data.17.18 %>% rename(Squad = Squad_17.18)
```

```{r EDA join tables}
data.17.22 <- data.21.22 %>% 
  inner_join(data.20.21, by="Squad") %>%
  inner_join(data.19.20, by="Squad") %>%
  inner_join(data.18.19, by="Squad") %>%
  inner_join(data.17.18, by="Squad")
names(data.17.22)
```
```{r EDA pivot longer, eval = F}
data.pivot <- data.17.22 %>%   # first create variable: payroll and year
